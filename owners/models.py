...
class House(models.Model):
    ...
    flooring_and_finishing = models.TextField(
        blank=True, verbose_name=_("Flooring and Finishing")
    )
    ...
    rules_and_restrictions = models.TextField(
        blank=True, null=True, verbose_name=_("Rules and Restrictions")
    )
    contact_information = models.TextField(verbose_name=_("Contact Information"))
    insurance_details = models.TextField(
        blank=True, null=True, verbose_name=_("Insurance Details")
    )
